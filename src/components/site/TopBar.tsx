...
export function TopBar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
      <div className="mx-auto max-w-[1600px] px-4 md:px-8 py-5 grid grid-cols-3 items-center border-b-2 border-foreground bg-background shadow-[0_4px_0_0_var(--color-foreground)]">
        ...
        <nav className="hidden md:flex justify-self-center items-center gap-2 pointer-events-auto font-pixel text-base bg-background border-2 border-foreground px-3 py-1.5">
