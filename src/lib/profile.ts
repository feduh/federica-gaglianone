...
export const timeline = [
  ...
  {
    year: "2025-2026",
    institution_en: "Standalones",
    institution_it: "Standalones",
    place: "—",
    body_en: "Standalone courses and independent research projects between degrees.",
    body_it: "Corsi singoli e progetti di ricerca indipendenti fra un percorso e l'altro.",
  },
  {
    year: "2022-2025",
  ...
  {
    year: "2015-2020",
    institution_en: "Liceo Artistico",
