...
export const timeline = [
  ...
  },
  {
    ...
    body_en: "Standalone courses in computer science taken between degrees to strengthen technical foundations.",
    body_it: "Corsi singoli in informatica seguiti tra una laurea e l'altra per rafforzare le basi tecniche.",
  },
  {
    year: "2022-2025",
    institution_en: "BA New Technologies for Art",
    institution_it: "Triennale in Nuove Tecnologie dell'Arte",
    place: "Albertina Academy of Fine Arts, Turin, Italy",
    body_en: "Joint honours program. Final dissertation on Bayesian confirmation theory in early modern astronomy.\n\n- Edisu Scholarship holder",
  ...
  },
  {
    ...
    place: "Liceo Artistico Aldo Passoni, Turin, Italy",
    body_en: "Five years at art high school: drawing, art history, and the slow craft of seeing carefully.",
    body_it: "Cinque anni di liceo artistico: disegno, storia dell'arte e l'arte lenta dell'osservazione.",
  },
];
